...
#### PS1 troubleshoot:
If you are going to run .ps1 files, maybe you will get an execution policies to bypass this:
- Open powershell as administrator
- Use this command: ``powershell.exe -executionpolicy unrestricted <FILE PATH>`` <br>
